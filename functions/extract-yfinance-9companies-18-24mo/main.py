...
def get_yfinance_data(ticker):
    """Fetch stock data for the given ticker using yfinance for 2 year ago and filter to 18-24 months range."""
    try:
        # Fetch the last 2 year of data and filter to 18-24 months ago
...
def task(request):
    ...
    try:
        ...
        return {"message": "YFinance 9 companies stock data for 18 to 24 months ago successfully inserted into MotherDuck"}, 200
    except Exception as e:
