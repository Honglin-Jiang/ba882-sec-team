...
def get_yfinance_data(ticker):
    """Fetch stock data for the given ticker using yfinance for 6 months ago range."""
    try:
...
def task(request):
    ...
    try:
        ...
        return {"message": "YFinance data for 6 months ago successfully inserted into MotherDuck"}, 200
    except Exception as e:
