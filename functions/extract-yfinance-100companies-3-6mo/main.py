...
def get_yfinance_data(ticker):
    """Fetch stock data for the given ticker using yfinance for 6 months ago and filter to 3-6 months range."""
    try:
        # Fetch the last 6 months of data and filter to 3-6 months ago
        end_date = datetime.now() - timedelta(days=30 * 3)
        ...
        # Filter to keep only data between 3 and 6 months ago
...
def task(request):
    ...
    try:
        ...
        return {"message": "YFinance data for 3 to 6 months ago successfully inserted into MotherDuck"}, 200
    except Exception as e:
