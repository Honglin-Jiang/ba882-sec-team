...
def get_yfinance_data(ticker):
    """Fetch stock data for the given ticker using yfinance for 1 year ago and filter to 6-12 months range."""
    try:
        # Fetch the last 1 year of data and filter to 6-12 months ago
        ...
        # Filter to keep only data between 6 and 12 months ago
...
def task(request):
    ...
    try:
        ...
        return {"message": "YFinance 9 companies stock data for 6 to 12 months ago successfully inserted into MotherDuck"}, 200
    except Exception as e:
