...
def get_yfinance_data(ticker):
    """Fetch stock data for the given ticker using yfinance for 5 year ago and filter to 30-60 months range."""
    try:
        # Fetch the last 5 year of data and filter to 30-60 months ago
        ...
        # Filter to keep only data between 30 and 40 months ago
...
def task(request):
    ...
    try:
        ...
        return {"message": "YFinance data for 30 to 60 months ago successfully inserted into MotherDuck"}, 200
    except Exception as e:
